const advantages = [
  {
    icon: "/svg/icons/expertise-icon.svg",
    title: "Expertise",
    description:
  ...
  {
    icon: "/svg/icons/client_centric-icon.svg",
  ...
  {
    icon: "/svg/icons/results_driven-icon.svg",
  ...
  {
    icon: "/svg/icons/collaborative_partnership-icon.svg",
